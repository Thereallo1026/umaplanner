...
export const Footer = () => {
  ...
  const footerLinks = [
    { external: false, href: "/", label: "Planner" },
    { external: false, href: "/faq", label: "FAQ" },
    {
      external: true,
        ...
        <nav aria-label="Footer Navigation">
          <ul className="flex gap-1">
            {footerLinks.map((link) => {
              const linkClassName =
                "text-xs font-medium uppercase hover:bg-white/20 py-1.5 px-3.5 rounded-md text-white/50 hover:text-white transition-colors duration-200";
