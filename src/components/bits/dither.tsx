...
/** biome-ignore-all lint/style/noNonNullAssertion: react bits component */
/** biome-ignore-all lint/suspicious/noExplicitAny: react bits component */
...
const DitheredWaves = ({
  ...
  useEffect(() => {
    const u = materialRef.current?.uniforms as WaveUniforms | undefined;
    if (!u) {
      return;
    }
